<script lang="ts" generics="TData, TValue">
	...
	import { tags, users, type Event } from '../columns';
		...
		{#if lebelCol && timeCol && nameCol}
			<ButtonGroup.Root>
				...
				<DataTableColFilter
					...
					options={userOptions}
				/>
				<DataTableColFilter icon={TagIcon} column={lebelCol} title="Tags" options={tags} />
		...
		<Table.Root>
			...
			<Table.Body>
				{#each table.getRowModel().rows as row (row.id)}
					<DataTableDialog log={row.original as Event}>
