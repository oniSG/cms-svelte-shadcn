...
<div class="space-y-3">
	<div class="space-y-2">
		<Label class="text-muted-foreground" for="action-name">
	...
	<div class="space-y-2">
		<Label class="text-muted-foreground" for="action-description">
	...
	<div class="flex items-center justify-between space-x-2">
		<Label class="text-muted-foreground" for="transaction-actions"
	...
	<div class="space-y-2">
		<Label class="text-muted-foreground" for="action-tags">{m.event_tags_label()}</Label>
		<MultiSelectCombobox
			id="action-tags"
